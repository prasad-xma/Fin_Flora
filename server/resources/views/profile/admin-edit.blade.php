...
@section('title', 'Edit Admin Profile - Fin & Flora')
...
<div class="profile-wrapper">
    <div class="profile-header">
        <h1 class="profile-title">Edit Admin Profile</h1>
        <p class="profile-subtitle">Update your administrator account details and password</p>
    </div>
